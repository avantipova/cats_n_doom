...
void			clip_1_outside(t_clip_triangle *cl, \
										t_model *model, int k, int i);
void			clip_2_outsides(t_clip_triangle *cl, \
										t_model *model, int k, int i);

void			clip_triangle(t_triangle *trs, t_plane *planes, t_model *model);

void			render_triangle(int *image_data, \
						t_model *model, t_triangle *tr, t_scene *scene);
...
int				if_possible_to_move(t_vertex pos, \
								t_bsp *node, int mode, float height);

void			get_floor_seil_traversal(t_bsp *node, \
								t_vertex pos, float *floor, float *ceil);
...
void			draw_pixel(t_scene *scene, int *image_data, \
											t_triangle *tr, int y_it);
