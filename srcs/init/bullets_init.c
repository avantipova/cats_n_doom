...
/*   Updated: 2021/04/24 22:21:49 by npetrell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "duke.h"

static void	init(t_model *bullet_model)
{
...
void	bullets_init(t_doom *doom)
{
	...
	init(&bullet_model);
	bullet_model.new_tex[0] = create_texture(ASSETS_FOLDER_NAME \
							"/textures/bullet.bmp", 0xfffaff08);
