...
/*   Updated: 2021/04/24 22:17:05 by npetrell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "duke.h"

static void	init(t_model *aid_model)
{
...
void	aid_init(t_doom *doom)
{
	...
	init(&aid_model);
	aid_model.new_tex[0] = create_texture(ASSETS_FOLDER_NAME \
								"/textures/aid.bmp", 0xff00feff);
